...
class Task(object):
    def __init__(self, domain_name, task_name, requirements,
                 types, objects, predicates, functions, init, goal, actions, axioms, fairnesses, use_metric):
    ...
    def parse(domain_pddl, task_pddl):
        ...
        task_name, task_domain_name, task_requirements, objects, init, goal, fairnesses, use_metric = parse_task(task_pddl)
        ...
        return Task(domain_name, task_name, requirements, types, objects,
                    predicates, functions, init, goal, actions, axioms, fairnesses, use_metric)
...
def parse_task(task_pddl):
    ...
    for entry in iterator:
        if entry[0] == ":fairness":
            fairnesses.append(fairness.extractFairness(entry))
        elif entry[0] == ":metric":
