...
class Simulator {
    std::shared_ptr<PartialState> current_state;
    std::shared_ptr<PartialState> current_goal;
...
//    Simulator(SearchEngine *eng, int argc, const char **argv, bool verb = true);
    Simulator(SearchEngine *eng, bool verb = true);
    ...
    void set_state(std::shared_ptr<PartialState>  s) { current_state = make_shared<PartialState> (*s); }
    void set_goal(std::shared_ptr<PartialState>  s) { current_goal = make_shared<PartialState> (*s); }
