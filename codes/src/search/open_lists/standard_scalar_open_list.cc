...
template<class Entry>
void StandardScalarOpenList<Entry>::evaluate(int g, bool preferred,int forbid_boost) {
    get_evaluator()->evaluate(g, preferred,forbid_boost);
    last_evaluated_value = forbid_boost + get_evaluator()->get_value();
