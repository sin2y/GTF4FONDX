(define (domain nestedqnp10)
	(:predicates (gr0_1) (gr0_2) (gr0_3) (gr0_4) (gr0_5) (gr0_6) (gr0_7) (gr0_8) (gr0_9) (gr0_10) (p) (q) (r))
	(:action a1
		:parameters ()
	...
	(:action a9
		:parameters ()
		:precondition (and (q) (gr0_9) (p) (not (gr0_8)))
		:effect (and (gr0_1) (gr0_2) (gr0_3) (gr0_4) (gr0_5) (gr0_6) (gr0_7) (gr0_8) (oneof (gr0_9) (not (gr0_9))) (not (p)) (not (q))))
	(:action a10
		:parameters ()
		:precondition (and (q) (gr0_10) (p) (not (gr0_9)))
		:effect (and (gr0_1) (gr0_2) (gr0_3) (gr0_4) (gr0_5) (gr0_6) (gr0_7) (gr0_8) (gr0_9) (oneof (gr0_10) (not (gr0_10))) (not (p)) (not (q))))
	(:action b
		:parameters ()
		:precondition (not (p))
