(define (domain HallsFloors-ND)
  ...
  (:constants tl tr bl br - corner)
      ...
      (:action mvd
       ...
       (:action discover-stair
       :parameters  (?f1 ?f2 - floor)
       :precondition (and (on ?f1) (visited-floor ?f1) (connected ?f1 ?f2)
                    (forall (?c - corner) (not (stair-in-corner ?f1 ?f2 ?c)))
       )
       :effect (oneof 
                    (and (stair-in-corner ?f1 ?f2 tl) (stair-in-corner ?f2 ?f1 tl))
                    (and (stair-in-corner ?f1 ?f2 tr) (stair-in-corner ?f2 ?f1 tr))
                    (and (stair-in-corner ?f1 ?f2 bl) (stair-in-corner ?f2 ?f1 bl))
                    (and (stair-in-corner ?f1 ?f2 br) (stair-in-corner ?f2 ?f1 br))))
