(define (problem HallsFloors-ND-5-2-2) ;spec: [[0, 2, 4, 6, 0], [2, 3], [4, 5], [], []]
  ...
  (:init
    ...
    (connected floor2 floor4)
    (connected floor4 floor2)
    (connected floor2 floor5)
    (connected floor5 floor2)
  )
  (:goal
    (and
