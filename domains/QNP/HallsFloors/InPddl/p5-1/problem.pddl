(define (problem HallsFloors-5-1) ;spec: [[0, 2, 4, 6, 0], [2], [3], [4], [5]]
  (:domain HallsFloors)
  (:objects
  ...
  (:init
    ...
    (stair-in-corner floor3 floor4 bl)
    (stair-in-corner floor4 floor3 bl)
    (stair-in-corner floor4 floor5 tl)
    (stair-in-corner floor5 floor4 tl)
  )
  (:goal
    (and
